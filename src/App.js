  ...
  render() {
    return (
      <div className="app">
        ...
        />
        <Experience onScrollToWaypoint={this.setActiveStep} />
        <Skills onScrollToWaypoint={this.setActiveStep} />

        <Projects onScrollToWaypoint={this.setActiveStep} />
        <Contact onScrollToWaypoint={this.setActiveStep} />
      </div>
    );
  }
}
