  ...
  >
    ...
    <div className='experience__list'>
      <Job 
        ...
        technologies={['Javascript', 'React', 'Scala', 'PHP', 'Apache Spark', 'Apache Thrift', 'AWS', 'Postgres', 'Google Dataproc', 'Git / GitHub', 'JIRA', 'Gerrit']}
      />
      <Job 
...
const Job = props => (
  <div className='job__wrapper'>
    ...
    <div className='job__description'>{Array.isArray(props.description) ? (
      <ul>
